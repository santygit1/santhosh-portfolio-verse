        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          <div className="bg-white dark:bg-gray-900 rounded-xl p-8 shadow-sm border border-gray-200 dark:border-gray-700 transition-colors">
            <div className="flex items-center mb-6">
              <div className="bg-modernBlue/10 p-3 rounded-full mr-4">
                <GraduationCap className="w-8 h-8 text-modernBlue" />
              </div>
              <div>
                <h3 className="text-xl font-bold text-gray-900 dark:text-white">SRM University</h3>
                <p className="text-modernBlue font-semibold">BCA in Data Science (2024–2027)</p>
              </div>
            </div>
          ...
          <div className="bg-white dark:bg-gray-900 rounded-xl p-8 shadow-sm border border-gray-200 dark:border-gray-700 transition-colors">
            <div className="flex items-center mb-6">
              <div className="bg-warmCoral/10 p-3 rounded-full mr-4">
                <Building2 className="w-8 h-8 text-warmCoral" />
              </div>
              <div>
                <h3 className="text-xl font-bold text-gray-900 dark:text-white">Institute of Venture Building</h3>
                <p className="text-warmCoral font-semibold">UG in Entrepreneurship & Full Stack Development (2024–2027)</p>
              </div>
            </div>
            <p className="text-gray-600 dark:text-gray-300">
